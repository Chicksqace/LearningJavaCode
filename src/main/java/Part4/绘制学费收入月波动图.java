...
public class 绘制学费收入月波动图 {
    public static void main(String[] args) {
        ...
        for (int sheetIndex=0;sheetIndex<sheetCount;sheetIndex++)
        {
            ...
            sales[sheetIndex]=学费总和;
            System.out.println(month+学费总和);
        }
        XSSFWorkbook wbChat = ExcelHelpers.createXLSX();
        XSSFSheet sheet = wbChat.createSheet();
        ...
        ExcelHelpers.saveToFile(wbChat,"d:/temp/学费波动.xlsx");
        ExcelHelpers.close(wbChat);
