...
public class 公司流水表生成Word报表2 {
    public static void main(String[] args) {
        ...
        Workbook wb = ExcelHelpers.openFile("d:/temp/公司账目2021年.xlsx");
        int sheetCount=wb.getNumberOfSheets();
        java.text.DecimalFormat df=new java.text.DecimalFormat("#.##");//小数点保留俩位
        for (int sheetIndex=0;sheetIndex<sheetCount;sheetIndex++)
        {
            ...
            WordHelpers.createRun(docx,"其他收入总额:"+df.format(学费收入总额));
            WordHelpers.createRun(docx,"工资支出总额:"+df.format(学费收入总额));
            WordHelpers.createRun(docx,"其他支出总额:"+df.format(学费收入总额));
            WordHelpers.createRun(docx,"总支出:"+df.format(学费收入总额));
            //生成饼状图
        ...
        WordHelpers.saveToFile(docx,"d:/temp/报表.docx");
